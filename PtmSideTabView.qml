...
PtmStatefulTabView {
    ...
    signal tabClosed(string title)

    // show or not close button
    property bool closable: true
    // tab background images
    property url tabBackground: "images/sideview_tab.png"
    property url tabActiveBackground: "images/sideview_tab_active.png"
