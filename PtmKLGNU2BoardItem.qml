                    ...
                    Item {
                        ...
                        Row {
                            ...
                            PtmPtmbcDaughterCardBoardLocationItem {
                                ...
                                location: "B"
                                //connector: "P4-1"
                                connector: Hardware.ptmbcConnectorS1FullName(root.fullName, 0, 6, ["B"], ["4"])
                            ...
                            PtmPtmbcDaughterCardBoardLocationItem {
                                ...
                                location: "B"
                                //connector: "P5-1"
                                connector: Hardware.ptmbcConnectorS1FullName(root.fullName, 0, 6, ["B"], ["5"])
                                defaultProgrammingConnector: progConnectorD.fullName
                            ...
                            PtmPtmbcDaughterCardBoardLocationItem {
                                ...
                                location: "B"
                                //connector: "P6-1"
                                connector: Hardware.ptmbcConnectorS1FullName(root.fullName, 0, 6, ["B"], ["6"])
                        ...
                        Row {
                            ...
                            Repeater {
                                ...
                                PtmPtmbcConnectorItem {
                                    idx: index
                                    label: Hardware.ptmbcConnectorS1Label((index <= 11 ? index : 17 - index), 6, ["B", "B", "B"], (index <= 11 ? ["4", "5", "6"] : ["6"]))
                                    fullName: Hardware.ptmbcConnectorS1FullName(root.fullName, (index <= 11 ? index : 17 - index), 6, ["B", "B", "B"], (index <= 11 ? ["4", "5", "6"] : ["6"]))
                                    onMouseLeftClicked: {
                        ...
                        Item {
                            ...
                            Row {
                                ...
                                PtmPtmbcDaughterCardBoardLocationItem {
                                    ...
                                    location: "A"
                                    //connector: "P1-1"
                                    connector: Hardware.ptmbcConnectorS1FullName(root.fullName, 0, 6, ["A"], ["1"])
                                ...
                                PtmPtmbcDaughterCardBoardLocationItem {
                                    ...
                                    location: "A"
                                    //connector: "P2-1"
                                    connector: Hardware.ptmbcConnectorS1FullName(root.fullName, 0, 6, ["A"], ["2"])
                                    defaultProgrammingConnector: progConnectorC.fullName
                            ...
                            Item {
                                ...
                                Row {
                                    ...
                                    Repeater {
                                        ...
                                        PtmPtmbcConnectorItem {
                                            idx: 18 + index
                                            label: Hardware.ptmbcConnectorS1Label((index <= 11 ? index : 17 - index), 6, ["A", "A", "A"], (index <= 11 ? ["1", "2", "3"] : ["3"]))
                                            fullName: Hardware.ptmbcConnectorS1FullName(root.fullName, (index <= 11 ? index : 17 - index), 6, ["A", "A", "A"], (index <= 11 ? ["1", "2", "3"] : ["3"]))
                                            anchorLabelToTop: false
                                            onMouseLeftClicked: {
                                                root.mouseLeftClicked("ptmbc", fullName);
                                            }
                ...
                GridLayout {
                    ...
                    Repeater {
                        ...
                        PtmQsfpPortItem {
                            labelColor: "#ffffff"
                            idx: index
                            label: Hardware.qsfpS1BoardPortLabel(2, index)
                            fullName: Hardware.qsfpS1BoardPortFullName(root.fullName, 2, index)
                            onMouseLeftClicked: {
