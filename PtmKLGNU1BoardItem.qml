                                ...
                                Row {
                                    ...
                                    Repeater {
                                        ...
                                        PtmPtmbcConnectorItem {
                                            idx: index
                                            label: Hardware.ptmbcConnectorS1Label(index, 6, ["A", "A"], ["1", "3"])
                                            fullName: Hardware.ptmbcConnectorS1FullName(root.fullName, index, 6, ["A", "A"], ["1", "3"])
                                            onMouseLeftClicked: {
                            ...
                            Row {
                                ...
                                Row {
                                    ...
                                    Repeater {
                                        ...
                                        PtmPtmbcConnectorItem {
                                            idx: 12 + index
                                            label: Hardware.ptmbcConnectorS1Label(11 - index, 6, ["A", "A"], ["4", "2"])
                                            fullName: Hardware.ptmbcConnectorS1FullName(root.fullName, 11 - index, 6, ["A", "A"], ["4", "2"])
                ...
                GridLayout {
                    ...
                    Repeater {
                        ...
                        PtmQsfpPortItem {
                            labelColor: "#ffffff"
                            idx: index
                            label: Hardware.qsfpS1BoardPortLabel(1, index)
                            fullName: Hardware.qsfpS1BoardPortFullName(root.fullName, 1, index)
                            onMouseLeftClicked: {
