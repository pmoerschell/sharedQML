/****************************************************************************
**
** This is a copy of Qt 5.9.6 TabViewStyle modified to allow using the
** component to implement style of custom tree view components.
** See type specification in declaration of content property.
**
****************************************************************************/
...
Style {
    ...
    /*! The \l ScrollView this style is attached to.
        ATTN: type is changed to "var" to enable style to use
        with any component implementing tree view */
